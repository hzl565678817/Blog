...
<div data-options="region:'west'," style="width:200px;padding:10px; color: darkcyan; background-color: #00bbee">
    <ul id="nav"></ul>
</div>
...
<script type="text/javascript" src="js/adminbz.js"></script>
