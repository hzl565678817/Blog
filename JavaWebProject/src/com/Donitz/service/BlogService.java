...
import com.Donitz.entity.BlogClass;
import com.Donitz.entity.UserInfo;
import com.Donitz.entity.Blog;

import com.Donitz.mapper.BlogMapper;
...
public class BlogService {
    ...
    public ArrayList<Blog> queryBlog(BlogClass blogClassObj, String title, UserInfo userObj, String addTime, String shzt, int currentPage) throws Exception {
        ...
        if (null != blogClassObj && blogClassObj.getBlogClassId() != null && blogClassObj.getBlogClassId() != 0)
            where += " and t_blog.blogClassObj=" + blogClassObj.getBlogClassId();
        ...
        if (null != userObj && userObj.getUser_name() != null && !userObj.getUser_name().equals(""))
            where += " and t_blog.userObj='" + userObj.getUser_name() + "'";
