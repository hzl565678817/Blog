...
public class UserController extends BasicController {
    ...
    @InitBinder("userInfo")
    public void BinderUserInfo(WebDataBinder binder) {
        binder.setFieldDefaultPrefix("userInfo.");
    }

    /*跳转到添加UserInfo视图*/
    @RequestMapping(value = "/add", method = RequestMethod.GET)
    public String addUser(Model model, HttpServletRequest request) throws Exception {
    ...
    public void addUser(@Validated UserInfo userInfo, BindingResult br,
    ...
    public void list(String user_name, String name, String birthDate, String telephone, Integer page, Integer rows, HttpServletResponse response) throws Exception {
    ...
    public String frontlist(String user_name, String name, String birthDate, String telephone, Integer currentPage, HttpServletRequest request) throws Exception {
    ...
    public String frontshow(@PathVariable String user_name, HttpServletRequest request) throws Exception {
    ...
    public void update(@PathVariable String user_name, HttpServletResponse response) throws Exception {
        /*根据主键user_name获取UserInfo对象*/
        UserInfo userInfo = userInfoService.getUserInfo(user_name);
    ...
    public void update(@Validated UserInfo userInfo, BindingResult br, HttpServletRequest request, HttpServletResponse response) throws Exception {
        String message;
        boolean success = false;
        if (br.hasErrors()) {
            message = "输入的信息有错误！";
    ...
    public void delete(String user_names, HttpServletResponse response) throws IOException, JSONException {
        String message = "";
        boolean success = false;
        try {
